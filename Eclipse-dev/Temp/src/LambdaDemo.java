...
public class LambdaDemo {
	...
	public static void main(String[] args) {
		...
		System.out.printf("18 + 36.5 = %s%n", calculate((double v1, double v2) -> v1 + v2, 18, 36.5));
		System.out.printf("89 / 2.9 = %s%n", calculate((double v1, double v2) -> v1 / v2, 89, 2.9));
		System.out.printf("-89 = %s%n", calculate((double v) -> -v, -89));
		System.out.printf("18 * 18 = %s%n", calculate((double v) -> v * v, 18));
